        ...
        <div class="header-content">
            ...
            <nav class="row header-nav-wrap">
                <ul class="header-nav">
                    ...
                    <li><a class="smoothscroll" href="#services" title="Services">Certificates and Honors</a></li>
    ...
    <section id="hero" class="s-hero target-section" data-parallax="scroll" data-image-src="images/hero-bg-3000.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="row hero-content">
            ...
            <div class="column large-full">
                ...
                <h1>
                Hello, I'm Malek Althubiany <br>
                a CyberSecurity Specialist <br>
                <br>
                ...
                <ul class="hero-social">
                    <li>
                        <a href="https://twitter.com/perhapsmalek" title="">Twitter</a>
                    </li>
                    <li>
                        <a href="https://www.linkedin.com/in/malek-althubiany-b82b65197/" title="">Linkedin</a>
                    </li>
            ...
            <div class="row">
                <div class="column large-6 medium-8 tab-full">
                    ...
                    <div class="section-intro" data-num="01" data-aos="fade-up">
                        ...
                        <h1 class="display-1">Hello again!</h1>
                    ...
                    <p data-aos="fade-up">
                    "A cybersecurity enthusiast who likes to contribute in every single aspect of cybersecurity, including technical, academic, and managerial aspects. I have worked as a security researcher, analyst, and in other roles, implementing several efficient cybersecurity projects."
                    </p>
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Imam Abdulrahman Bin Faisal</span>
                                <span class="position__pos">CyberSeucrity and Digital Forensics Student</span>
                            </h6>
                        ...
                        <p>
completed 158 hours of cybersecurity courses and have implemented several related cybersecurity projects.
                        </p>
                    </div>
                </div> <!-- end column -->
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">Cipher Company For Cyber Security</span>
				<br></br>
                                <span class="position__pos">CyberSecurity Sepcialist </span>
                            </h6>
                            <div class="position__timeframe">
                                june 2022 - Dec 2022
                            </div>
                        ...
                        <p>
                        Working under penetration testing and SOC departments. 
                        </p>
                    </div>
                </div> <!-- end column -->
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co">IMAM ABDULRAHMAN BIN FAISAL</span>
<br></br>
                                <span class="position__pos">Penetration Tester</span>
                            </h6>
                            <div class="position__timeframe">
                                june 2022- nov 2022
                            </div>
                ...
                <div class="column" data-aos="fade-up">
                    <div class="position">
                        <div class="position__header">
                            <h6>
                                <span class="position__co"></span>
                                <span class="position__pos">Security Researcher</span>
                            </h6>
                            <div class="position__timeframe">
                                June 2022 - Peresent
                            </div>
                        ...
                        <p>
                        Bug hunter, contributing to scientific papers.
        ...
        <div class="row s-services__content">
            ...
            <div class="column large-6 s-services__leftcol">
                <div class="section-intro" data-num="02" data-aos="fade-up">
                    <h3 class="subhead">Certificates and Honors</h3>
              ...
              I always obtain a certificate to validate the concepts that I have studied.
                </p>
                ...
                <ul class="services-list" data-aos="fade-up">
                    <li class="services-list__item is-active">
                        <div class="services-list__item-header">
                            <h5>eLearnSecurity Certified Professional Penetration Tester (eCPPTv2)</h5>
                        </div>
                    ...
                    <li class="services-list__item">
                        <div class="services-list__item-header">
                            <h5>eLearnSecurity Web Application Penetration Tester (eWPT)</h5>
                        </div>
                        <div class="services-list__item-body">
                    ...
                    <li class="services-list__item">
                        <div class="services-list__item-header">
                            <h5>Junior Penetration Tester (eJPT)</h5>
                        </div>
                        <div class="services-list__item-body">
            ...
            <div class="column" data-aos="fade-up">
                <div class="folio-item">
                    ...
                    <div class="folio-item__info">
                        ...
                        <h4 class="folio-item__title">AirForce Security</h4>
                    </div>
                    <a href="https://www.linkedin.com/feed/update/urn:li:activity:7059856184513634305?utm_source=share&utm_medium=member_desktop" title="Project Link" class="folio-item__project-link">Project Link</a>
                    <div class="folio-item__caption">
                        <p>A hybird smart technique to detect EvilTwin attacks by ML and Statisctal Analysis.</p>
                    </div>
                </div>
            </div> <!-- end column -->
            <div class="column" data-aos="fade-up">
                <div class="folio-item">
                    ...
                    <div class="folio-item__info">
                        <div class="folio-item__cat">Publications</div>
                        <h4 class="folio-item__title">IEEE publications</h4>
                    </div>
                    <a href="https://www.linkedin.com/feed/update/urn:li:activity:7065268873410805760/" title="Project Link" class="folio-item__project-link">Project Link</a>
                    <div class="folio-item__caption">
                        <p>Testing and Exploiting Tools to Improve OWASP Top Ten Security Vulnerabilities Detection.</p>
                    </div>
                </div>
            </div> <!-- end column -->
            <div class="column" data-aos="fade-up">
                <div class="folio-item">
                    ...
                    <div class="folio-item__info">
                        <div class="folio-item__cat">A blog</div>
                        <h4 class="folio-item__title">HTTP smuggling</h4>
                    </div>
                    <a href="https://github.com/MalekAlthubiany/HTTPsmugglingARABIC/issues/1#issuecomment-1463829987" title="Project Link" class="folio-item__project-link">Project Link</a>
                    <div class="folio-item__caption">
                        <p>An Arabic Blog about HTTP smuggling vulnerability</p>
                    </div>
                </div>
            </div> <!-- end column -->
    ...
    ================================================== -->
	<!-- CTA
   <!-- end column --> <section id="testimonials" class="s-testimonials">
    ...
    <footer class="s-footer h-dark-bg">
        ...
        <div class="row s-footer__main">
            <div class="column large-6">
                ...
                <div class="footer-email-us">
                    <a href="https://twitter.com/perhapsmalek" class="btn btn--primary h-full-width">Let's Talk</a>
                </div>
            </div>
                ...
                <div class="footer-contacts">
                    ...
                    <div class="footer-contact-block" data-aos="fade-up">
                        ...
                        <ul class="footer-contact-block__list">
                            <li><a href="https://twitter.com/perhapsmalek">Twitter</a></li>
                            <li><a href="https://www.linkedin.com/in/malek-althubiany-b82b65197/">linkedin</a></li>
                        </ul>
                    </div> <!-- end footer-contact-block -->
                </div>
            </div>
        ...
        <div class="row s-footer__bottom">
            <div class="column large-full ss-copyright">
                <span>© Copyright Malek Althubiany </span> 
                <span>Design by Malek</a></span>
